...
def user_conta(view_function):
    ...
    def decorator_function(*args, **kwargs):
        ...
        if conta is None:
            ...
            return make_response(jsonify("Esta conta não pertence ao usuario logado"), 403)
    ...
    def decorator_function(*args, **kwargs):
        ...
        if operacao is None:
            ...
            if conta.usuario_id == usuario_logado:
                ...
                return make_response(jsonify("Esta operação não pertence ao usuario logado"), 403)
